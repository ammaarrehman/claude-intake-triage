...
`secondary_categories`, which raises needs coverage on the multi-need cases.
Run both versions and paste your real numbers into
[`evals/results_v1.md`](evals/) and [`evals/results_v2.md`](evals/) — those files
